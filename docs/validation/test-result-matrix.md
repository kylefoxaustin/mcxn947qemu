...
| Block | Present | Driver-binds | Class | Tested-by | Result |
|-------|:---:|:---:|-------|-----------|:---:|
| ctimer | ✓ | ✓ | functional | mcxn-ctimer, mcxn-timers, mcxn-ctimer-dma, mcxn-ctimer-capture | SKIP |
...
| smartdma | ✓ | ◐ | proprietary | mcxn-smartdma | SKIP |
| neutron-npu | ✓ | ✓ | proprietary | mcxn-neutron | SKIP |

## Analog (operator-driven)

| Block | Present | Driver-binds | Class | Tested-by | Result |
|-------|:---:|:---:|-------|-----------|:---:|
| adc | ✓ | ✓ | operator-driven | mcxn-adc, mcxn-adc-dma, mcxn-adc-fifo, mcxn-adc-hwtrig, mcxn-adc-ctimer-trig, mcxn-adc-ctimer-adc1-trig, mcxn-adc-pwm-trig | SKIP |
| cmp | ✓ | ✓ | operator-driven | mcxn-cmp, mcxn-cmp-dma, mcxn-cmp-trig | SKIP |
| tsi | ✓ | ✓ | operator-driven | mcxn-tsi, mcxn-tsi-trig | SKIP |
| dac | ✓ | ✓ | functional | mcxn-dac, mcxn-dac-dma, mcxn-dac-hwtrig | SKIP |
...
| inputmux | ✓ | ✓ | functional | mcxn-inputmux-gate, mcxn-adc-hwtrig, mcxn-adc-ctimer-trig, mcxn-adc-ctimer-adc1-trig, mcxn-adc-pwm-trig, mcxn-dac-hwtrig, mcxn-cmp-trig, mcxn-qdc-trig, mcxn-tsi-trig, mcxn-reset-values | SKIP |
