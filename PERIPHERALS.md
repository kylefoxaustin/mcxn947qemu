...
| `SCG` | 1 | ✅ functional — sources (FRO12M/FRO_HF) + **PLL0/PLL1 derived** from APLL/SPLL NDIV/MDIV/PDIV (RM formula), muxed by SYSCON to CTIMER/SCT; a timer clocked from PLL0 follows a PLL reconfigure. tests/mcxn-pll-ctimer. (Core clock/SysTick still on the board 150 MHz constant — a later phase.) |
